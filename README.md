...
| Asynchronous <br /> Online | S12: File Handling | `Live Code Demo:` Text File I/O, Binary File I/O, `Tutorial:` Random Access File Read | `SOON` | [P12-File_Handling](./Session12-File_Handling/P12-File_Handling.pdf) | [Replit](https://replit.com/@NivedhithaD/Session12-FileHandling), `SOON` | `SOON` |
