...
| 18-June-2022 <br />06:30 - 8:00 PM <br />Online | S08: Recursive Functions and Modules | `Live Code Demo:` Fibonacci, Factorial, Variable Scopes in C `Tutorial:` Recursion with Pointers and Strings | `SOON` | `SOON` | [Replit](https://replit.com/@NivedhithaD/Session08-RecursiveFunctions), `SOON` | `SOON` |
